...
Wildflower Narrows is available with `?contract=wildflower-narrows`: it is a 66-second narrow bloom route with `230 Grass / 320 Flowers / 24 Fiber` quotas, tight flower corridors, compact internal gaps, and deterministic balance that requires every flower pocket, all dense weeds, and six shrubs without a Wood gate.
