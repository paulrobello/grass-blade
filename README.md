...
- `?contract=meadow-delivery`, `?contract=flower-sweep`, `?contract=woodland-cleanup`, or `?contract=timed-harvest` selects the authored contract template; unknown IDs fall back to `meadow-delivery`.
