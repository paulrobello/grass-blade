...
Sunset Switchback is available with `?contract=sunset-switchback`: it is a 120-second diagonal switchback route with `260 Grass / 300 Flowers / 28 Fiber` quotas, no Wood gate, sunset-toned flower lanes, and deterministic balance that requires all dense weeds and all shrubs.
