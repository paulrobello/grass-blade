...
These hooks include the current mode, result snapshot, inventory, objectives, XP, RPM, target counts, live blade-contact target IDs, too-tough notice diagnostics, partially cut target work, recent authoritative cut events, blade presentation tier and orientation cue, and pooled-fragment diagnostics. See [progress.md](progress.md) for the recorded evidence.
