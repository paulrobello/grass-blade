...
Willow Weave is available with `?contract=willow-weave`: it is an 80-second woven grove route with `250 Grass / 300 Flowers / 24 Fiber / 22 Wood` quotas, braided flower lanes through saplings and mature-tree pockets, and deterministic balance that requires all dense weeds, six shrubs, all five saplings, and two mature trees.

Petal Gate is available with `?contract=petal-gate`: it is a 72-second flower-gate route with `250 Grass / 320 Flowers / 28 Fiber` quotas, no Wood gate, a lattice of cross-lanes and compact internal gaps, and deterministic balance that requires every flower pocket, all dense weeds, and all shrubs.

Sunset Switchback is available with `?contract=sunset-switchback`: it is a 74-second diagonal switchback route with `260 Grass / 300 Flowers / 28 Fiber` quotas, no Wood gate, sunset-toned flower lanes, and deterministic balance that requires all dense weeds and all shrubs.
